...
class _UpdatetaskWidgetState extends State<UpdatetaskWidget> {
  ...
  void initState() {
    super.initState();
    shortBioController = TextEditingController(text: widget.tasupdate!.desc);
    userNameController =
        TextEditingController(text: widget.tasupdate!.taskname);
  }
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(220, 22, 0, 0),
                          child: InkWell(
                            onDoubleTap: () async {
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(22, 28, 0, 0),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Padding(
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(26, 8, 30, 0),
                        child: TextFormField(
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(22, 22, 0, 0),
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Padding(
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(26, 12, 30, 0),
                        child: FlutterFlowDropDown(
                          initialOption: teamSelectValue ??=
                              widget.tasupdate!.type,
                          options: [
                            'Type 1',
                            'Type 2',
                            'Type 3',
                          ...
                          borderWidth: 1,
                          borderRadius: 12,
                          margin: EdgeInsetsDirectional.fromSTEB(6, 2, 6, 2),
                          hidesUnderline: true,
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            contentPadding:
                                EdgeInsetsDirectional.fromSTEB(10, 22, 20, 0),
                          ),
                          style: FlutterFlowTheme.of(context)
                              .bodyText1
                              .override(
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0, 132, 0, 0),
                  child: Container(
                    width: double.infinity,
                    height: 160,
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(32, 52, 32, 52),
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await widget.tasupdate!.reference
